...
function cadastrar(req, res){
  ...
  usuarioModel.cadastrar(email, senha, tipoConta,nome,cpf,telefone).then(function(resposta){
      res.json(resposta)
...
module.exports = {
    ...
    uploadProfilePhoto: (req, res) => {
        upload(req, res, async (err) => {
            ...
            try {
                await userModel.updateProfilePhoto(req.user.id, req.file.path);
                res.json({ 
                    success: true,
    ...
    getProfilePhoto: async (req, res) => {
        try {
            const photoPath = await userModel.getProfilePhoto(req.params.userId);
